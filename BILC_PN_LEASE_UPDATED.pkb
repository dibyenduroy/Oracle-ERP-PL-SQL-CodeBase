CREATE OR REPLACE PACKAGE BODY APPS.bilc_pn_lease_updated IS
 ...
 BEGIN
    ...
    BEGIN
       ...
       wf_engine.createprocess (itemtype      => 'BTWFNOTF',
          ...
          wf_engine.setitemattrtext('BTWFNOTF',
                                   l_itemkey,
                                   'MESSAGE',
                                   'The lease with following details,has been finalized/updated.'
                                   || CHR (10)
                                   || CHR (10)
                                   || 'Lease Number    : '
                                   || l_lease_num
    ...
    END;
    END LOOP;
 END bilc_pn_lease_update_notify;
